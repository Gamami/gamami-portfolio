            ...
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-2">
                  Halo, Saya seorang Junior Programmer yang passionate dalam
                  dunia coding dan teknologi. Saya suka membangun aplikasi
                  dengan bebrapa teknologi bahasa pemograman dan terus belajar
                  hal baru dalam dunia pengembangan software.
                </p>
              </div>
